...
function buildVariables(name, entity, port) {
    return {
        name,
...
async function renderDirectory(source, destination, variables) {
...
export async function generateFromTemplate(templateKey, name, options = {}) {
    if (!name) {
